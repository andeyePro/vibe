...
- An opt-in cross-org learning library (`vibe learn --init`) – you choose where it lives, public or private, and capture patterns from any project. Mounts into every container at `/learnings`. The `/learn` slash command lets you capture entries from inside a session.
