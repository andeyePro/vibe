---
name: vs
description: Runs vibe's /vs adversarial harness by reading and following /usr/local/share/vibe/commands/vs.md.
---

# $vs

Read `/usr/local/share/vibe/commands/vs.md` now, in full, and follow it
