...
- **"Keep going / burn my session"** intent: suggest `/vsss`, plus `--sessions X` (total credit windows, e.g. `--sessions 3` = current window plus up to 2 automatic relaunches) if they want it to span credit-window resets.
